...
class TestConverters(unittest.TestCase):
    ...
    def test_float_converter(self):
        self.assertAlmostEqual(Float.to_python(" 123.  "), 123.0)
        self.assertAlmostEqual(Float.to_python(" 123.45 "), 123.45)
        self.assertAlmostEqual(Float.to_python("-123.45"), -123.45)
        self.assertAlmostEqual(Float.to_python("+123.45"), 123.45)
        self.assertAlmostEqual(Float.to_python("+123.45E+5"), 123.45e5)
        self.assertAlmostEqual(Float.to_python("+123.45E5"), 123.45e5)
        self.assertAlmostEqual(Float.to_python("+123.45e+5"), 123.45e5)
        self.assertAlmostEqual(Float.to_python("+123.45e5"), 123.45e5)
        self.assertAlmostEqual(Float.to_python("+123.45E-5"), 123.45e-5)
        self.assertAlmostEqual(Float.to_python("+123.45e-5"), 123.45e-5)
        self.assertRegex(" 123. ", Float.regex("test"))
